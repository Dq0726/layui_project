 ...
 */
@RestController
@RequestMapping("/zkmes/invmgmt/semifinishedin")
public class ZkmesInvmgmtSemifinishedinController extends BaseController {
	 ...
	 * 获取半成品入库列表
	 */
	@PreAuthorize("@ss.hasPermi('zkmes:invmgmt:semifinishedin:list')")
	@GetMapping("/list")
	 ...
	 * 根据半成品入库编号获取详细信息
	 */
	@PreAuthorize("@ss.hasPermi('zkmes:invmgmt:semifinishedin:query')")
	@GetMapping(value = "/{Id}")
	 ...
	 * 新增半成品入库
	 */
	@PreAuthorize("@ss.hasPermi('zkmes:invmgmt:semifinishedin:add')")
	@Log(title = "半成品入库", businessType = BusinessType.INSERT)
	@PostMapping
	 ...
	 * 修改半成品入库
	 */
	@PreAuthorize("@ss.hasPermi('zkmes:invmgmt:semifinishedin:edit')")
	@Log(title = "半成品入库", businessType = BusinessType.UPDATE)
	@PutMapping
	 ...
	 * 删除半成品入库
	 */
	@PreAuthorize("@ss.hasPermi('zkmes:invmgmt:semifinishedin:remove')")
	@Log(title = "半成品入库", businessType = BusinessType.DELETE)
	@DeleteMapping("/{Ids}")
	...
	// /zkmes/invmgmt/semifinishedin/product
	// //////////////////////////////////////////////////////////////////////////////

	/**
	 * 获取半成品入库单产品列表
	 */
	@PreAuthorize("@ss.hasPermi('zkmes:invmgmt:semifinishedin:product:list')")
	 ...
	 * 新增半成品入库单产品
	 */
	@PreAuthorize("@ss.hasPermi('zkmes:invmgmt:semifinishedin:product:add')")
	@Log(title = "半成品入库单产品", businessType = BusinessType.INSERT)
	@PostMapping("/product")
	 ...
	 * 修改半成品入库单产品
	 */
	@PreAuthorize("@ss.hasPermi('zkmes:invmgmt:semifinishedin:product:edit')")
	@Log(title = "半成品入库单产品", businessType = BusinessType.UPDATE)
	@PutMapping("/product")
	 ...
	 * 半成品入库单产品同步入库
	 */
	@PreAuthorize("@ss.hasPermi('zkmes:invmgmt:semifinishedin:product:sync')")
	@Log(title = "半成品入库单产品同步入库", businessType = BusinessType.UPDATE)
